package com.coolhand.kafka.steam.orders.producer;
...
import com.coolhand.kafka.stream.orders.domain.OrderLineItem;
...
import static com.coolhand.kafka.steam.orders.producer.ProducerUtil.publishMessageSync;
    ...
    private static void publishOrder(ObjectMapper objectMapper, List<Order> newOrder) {
        newOrder
                ...
                try {
                    ...
                    var recordMetaData = publishMessageSync(OrderManagementTopology.ORDERS,order.orderId()+"",orderJSON);
